...
*Search terms: {{searchTerms}}*`
        ...
        // Herb/Plant Template
        templates.set('herb-profile', {
            name: 'Herb Profile',
            description: 'Specialized template for herbs and plants',
            requiredFields: ['title', 'description'],
            optionalFields: ['uses', 'research', 'warnings', 'properties'],
            template: `---
title: {{title}}
type: herb
category: botanical
tags: [herb, botanical, {{category}}, research, auto-generated]
generated: {{generationDate}}
quality: {{qualityScore}}
---
...
## Preparation Methods
*[This section can be expanded based on research findings]*
...
---
*🤖 Auto-generated by CLIPPY AI Assistant*
*📅 Generated: {{generationDate}}*
*🔍 Research Quality: {{qualityScore}}*`
        });

        // Simple Template
        templates.set('simple', {
            name: 'Simple',
            description: 'Basic template with minimal sections',
            requiredFields: ['title', 'description'],
...
*Generated: {{generationDate}}*`
        ...
        // Medical Template
        templates.set('medical', {
            name: 'Medical Research',
            description: 'Template focused on medical/health information',
            requiredFields: ['title', 'description'],
            optionalFields: ['uses', 'research', 'warnings'],
            template: `---
title: {{title}}
type: medical-research
tags: [medical, health, research, auto-generated]
quality: {{qualityScore}}
generated: {{generationDate}}
...
*Generated by CLIPPY AI Assistant - {{generationDate}}*`
        });
